...
class RobotDrive(Node):
    def __init__(self):
        ...
        self.buffer = Buffer(Duration(seconds=10))  # tf 버퍼 크기를 증가시킵니다.
        ...
        self.laser_subscription = self.create_subscription(LaserScan, '/scan', self.laser_callback, qos_profile_default)
    ...
    def reach_goal_orientation(self):
        ...
        if self.current_pose is None:
            self.get_logger().error("Current pose is None, cannot adjust orientation.")
            return

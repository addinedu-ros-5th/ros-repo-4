...
#ifndef ROBOT_STATE__SRV__DETAIL__UPDATE_DB__FUNCTIONS_H_
#define ROBOT_STATE__SRV__DETAIL__UPDATE_DB__FUNCTIONS_H_
...
/// Initialize srv/UpdateDB message.
/**
...
/// Create srv/UpdateDB message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_state__srv__UpdateDB_Request__init().
...
/// Destroy srv/UpdateDB message.
/**
 * It calls
 * robot_state__srv__UpdateDB_Request__fini()
...
/// Check for srv/UpdateDB message equality.
/**
...
/// Initialize array of srv/UpdateDB messages.
/**
...
/// Finalize array of srv/UpdateDB messages.
/**
 * It calls
 * robot_state__srv__UpdateDB_Request__fini()
...
/// Create array of srv/UpdateDB messages.
/**
 * It allocates the memory for the array and calls
 * robot_state__srv__UpdateDB_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/UpdateDB messages.
/**
 * It calls
 * robot_state__srv__UpdateDB_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/UpdateDB message array equality.
/**
...
/// Copy an array of srv/UpdateDB messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_state__srv__UpdateDB_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_state
...
/**
 * It calls
 * robot_state__srv__UpdateDB_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_state
...
/**
 * It allocates the memory for the array and calls
 * robot_state__srv__UpdateDB_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_state
...
/**
 * It calls
 * robot_state__srv__UpdateDB_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBOT_STATE__SRV__DETAIL__UPDATE_DB__FUNCTIONS_H_

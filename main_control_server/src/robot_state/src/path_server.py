...
pose_dict = {
    ...
    "R_B1": [0.68, 1.50, 0.7, 0.7], "R_B2": [0.68, 1.50, 0.7, 0.7], "R_B3": [0.68, 1.50, 0.7, 0.7],
...
class PathServer(Node):
    def __init__(self):
        ...
        self.task_done_subscription = self.create_subscription(Bool, 'light_off_2', self.light_off_callback2, 10)
    ...
    def light_off_callback2(self, msg: Bool):
        if msg.data:
            with self.lock:
